...
/** Allowed Content Types of the PaYookassaPaymentMode taxonomy. */
export enum ContentTypesOfPaYookassaPaymentModeEnum {
  /** The Type of Content object */
  Product = 'PRODUCT'
}

/** Allowed Content Types of the PaYookassaPaymentSubject taxonomy. */
export enum ContentTypesOfPaYookassaPaymentSubjectEnum {
  /** The Type of Content object */
  Product = 'PRODUCT'
}
...
/** Input for the createPaYookassaPaymentMode mutation */
export type CreatePaYookassaPaymentModeInput = {
  /** The slug that the pa_yookassa_payment_mode will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The description of the pa_yookassa_payment_mode object */
  description?: InputMaybe<Scalars['String']>;
  /** The name of the pa_yookassa_payment_mode object to mutate */
  name: Scalars['String'];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars['String']>;
};

/** The payload for the createPaYookassaPaymentMode mutation */
export type CreatePaYookassaPaymentModePayload = {
  __typename?: 'CreatePaYookassaPaymentModePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The created pa_yookassa_payment_mode */
  paYookassaPaymentMode?: Maybe<PaYookassaPaymentMode>;
};

/** Input for the createPaYookassaPaymentSubject mutation */
export type CreatePaYookassaPaymentSubjectInput = {
  /** The slug that the pa_yookassa_payment_subject will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The description of the pa_yookassa_payment_subject object */
  description?: InputMaybe<Scalars['String']>;
  /** The name of the pa_yookassa_payment_subject object to mutate */
  name: Scalars['String'];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars['String']>;
};

/** The payload for the createPaYookassaPaymentSubject mutation */
export type CreatePaYookassaPaymentSubjectPayload = {
  __typename?: 'CreatePaYookassaPaymentSubjectPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The created pa_yookassa_payment_subject */
  paYookassaPaymentSubject?: Maybe<PaYookassaPaymentSubject>;
};
...
/** Input for the deletePaYookassaPaymentMode mutation */
export type DeletePaYookassaPaymentModeInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The ID of the paYookassaPaymentMode to delete */
  id: Scalars['ID'];
};

/** The payload for the deletePaYookassaPaymentMode mutation */
export type DeletePaYookassaPaymentModePayload = {
  __typename?: 'DeletePaYookassaPaymentModePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']>;
...
/** Input for the deletePaYookassaPaymentSubject mutation */
export type DeletePaYookassaPaymentSubjectInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The ID of the paYookassaPaymentSubject to delete */
  id: Scalars['ID'];
};

/** The payload for the deletePaYookassaPaymentSubject mutation */
export type DeletePaYookassaPaymentSubjectPayload = {
  __typename?: 'DeletePaYookassaPaymentSubjectPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']>;
...
export enum DiscountTypeEnum {
  /** WDP Coupon (exact item application) */
  AdpFixedCartItem = 'ADP_FIXED_CART_ITEM',
  ...
  Percent = 'PERCENT',
  /** WDP Coupon */
  WdpPercentLimitCoupon = 'WDP_PERCENT_LIMIT_COUPON'
}
...
/** The Document type */
export type Document = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
  __typename?: 'Document';
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  ...
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Документы — Основное&quot; was set to Show in GraphQL. */
  documentMain?: Maybe<Document_Documentmain>;
  /** If a user has edited the node within the past 15 seconds, this will return the user that last edited. Null if the edit lock doesn&#039;t exist or is greater than 15 seconds */
  editingLockedBy?: Maybe<ContentNodeToEditLockConnectionEdge>;
  /** The RSS enclosure for the object */
  enclosure?: Maybe<Scalars['String']>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']>;
  /** The globally unique identifier of the documents object. */
  id: Scalars['ID'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean'];
  /** Whether the object is a node in the preview state */
...
/** The Document type */
export type DocumentExcerptArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};
...
/** Field Group */
export type Document_Documentmain = AcfFieldGroup & {
  __typename?: 'Document_Documentmain';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
...
export type ExternalProduct = ContentNode & DatabaseIdentifier & Node & NodeWithComments & NodeWithContentEditor & NodeWithFeaturedImage & Product & UniformResourceIdentifiable & {
  ...
  /** Connection between the Product type and the paYookassaPaymentMode type */
  paYookassaPaymentModes?: Maybe<ProductToPaYookassaPaymentModeConnection>;
  /** Connection between the Product type and the paYookassaPaymentSubject type */
  paYookassaPaymentSubjects?: Maybe<ProductToPaYookassaPaymentSubjectConnection>;
  /** Parent product */
  ...
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Товар – Дополнительные поля&quot; was set to Show in GraphQL. */
  productAdditional?: Maybe<Product_Productadditional>;
...
/** A external product object */
export type ExternalProductPaYookassaPaymentModesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<ProductToPaYookassaPaymentModeConnectionWhereArgs>;
};


/** A external product object */
export type ExternalProductPaYookassaPaymentSubjectsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<ProductToPaYookassaPaymentSubjectConnectionWhereArgs>;
};
...
/** A group product object */
export type GroupProductPaYookassaPaymentModesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** A group product object */
export type GroupProductPaYookassaPaymentSubjectsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The paYookassaPaymentMode type */
export type PaYookassaPaymentMode = DatabaseIdentifier & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'PaYookassaPaymentMode';
  /** Connection between the paYookassaPaymentMode type and the ContentNode type */
  contentNodes?: Maybe<PaYookassaPaymentModeToContentNodeConnection>;
  /** The number of objects connected to the object */
  count?: Maybe<Scalars['Int']>;
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int'];
   ...
   * @deprecated Deprecated in favor of databaseId
   */
  paYookassaPaymentModeId?: Maybe<Scalars['Int']>;
  /** Connection between the PaYookassaPaymentMode type and the Product type */
  products?: Maybe<PaYookassaPaymentModeToProductConnection>;
  /** An alphanumeric identifier for the object unique to its type. */
  slug?: Maybe<Scalars['String']>;
  /** Connection between the paYookassaPaymentMode type and the Taxonomy type */
  taxonomy?: Maybe<PaYookassaPaymentModeToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  taxonomyName?: Maybe<Scalars['String']>;
  /** The ID of the term group that this term object belongs to */
  termGroupId?: Maybe<Scalars['Int']>;
  ...
  /** The unique resource identifier path */
  uri?: Maybe<Scalars['String']>;
  /** Connection between the PaYookassaPaymentMode type and the ProductVariation type */
  variations?: Maybe<PaYookassaPaymentModeToProductVariationConnection>;
};


/** The paYookassaPaymentMode type */
export type PaYookassaPaymentModeContentNodesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<PaYookassaPaymentModeToContentNodeConnectionWhereArgs>;
};


/** The paYookassaPaymentMode type */
export type PaYookassaPaymentModeEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The paYookassaPaymentMode type */
export type PaYookassaPaymentModeEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The paYookassaPaymentMode type */
export type PaYookassaPaymentModeProductsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<PaYookassaPaymentModeToProductConnectionWhereArgs>;
};


/** The paYookassaPaymentMode type */
export type PaYookassaPaymentModeVariationsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<PaYookassaPaymentModeToProductVariationConnectionWhereArgs>;
};

/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum PaYookassaPaymentModeIdType {
  /** The Database ID for the node */
  DatabaseId = 'DATABASE_ID',
  /** The hashed Global ID */
  Id = 'ID',
...
/** Connection between the paYookassaPaymentMode type and the ContentNode type */
export type PaYookassaPaymentModeToContentNodeConnection = {
  __typename?: 'PaYookassaPaymentModeToContentNodeConnection';
  /** Edges for the PaYookassaPaymentModeToContentNodeConnection connection */
  edges?: Maybe<Array<Maybe<PaYookassaPaymentModeToContentNodeConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<ContentNode>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type PaYookassaPaymentModeToContentNodeConnectionEdge = {
  __typename?: 'PaYookassaPaymentModeToContentNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<ContentNode>;
...
/** Arguments for filtering the PaYookassaPaymentModeToContentNodeConnection connection */
export type PaYookassaPaymentModeToContentNodeConnectionWhereArgs = {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfPaYookassaPaymentModeEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']>;
...
/** Connection between the PaYookassaPaymentMode type and the Product type */
export type PaYookassaPaymentModeToProductConnection = {
  __typename?: 'PaYookassaPaymentModeToProductConnection';
  /** Edges for the PaYookassaPaymentModeToProductConnection connection */
  edges?: Maybe<Array<Maybe<PaYookassaPaymentModeToProductConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Product>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type PaYookassaPaymentModeToProductConnectionEdge = {
  __typename?: 'PaYookassaPaymentModeToProductConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Product>;
...
/** Arguments for filtering the PaYookassaPaymentModeToProductConnection connection */
export type PaYookassaPaymentModeToProductConnectionWhereArgs = {
  /** Limit result set to products with a specific attribute. Use the taxonomy name/attribute slug. */
  attribute?: InputMaybe<Scalars['String']>;
  /** Limit result set to products with a specific attribute term ID (required an assigned attribute). */
  attributeTerm?: InputMaybe<Scalars['String']>;
...
/** Connection between the PaYookassaPaymentMode type and the ProductVariation type */
export type PaYookassaPaymentModeToProductVariationConnection = {
  __typename?: 'PaYookassaPaymentModeToProductVariationConnection';
  /** Edges for the PaYookassaPaymentModeToProductVariationConnection connection */
  edges?: Maybe<Array<Maybe<PaYookassaPaymentModeToProductVariationConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
...
/** An edge in a connection */
export type PaYookassaPaymentModeToProductVariationConnectionEdge = {
  __typename?: 'PaYookassaPaymentModeToProductVariationConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<ProductVariation>;
...
/** Arguments for filtering the PaYookassaPaymentModeToProductVariationConnection connection */
export type PaYookassaPaymentModeToProductVariationConnectionWhereArgs = {
  /** Limit result set to products with a specific attribute. Use the taxonomy name/attribute slug. */
  attribute?: InputMaybe<Scalars['String']>;
  /** Limit result set to products with a specific attribute term ID (required an assigned attribute). */
  attributeTerm?: InputMaybe<Scalars['String']>;
...
/** Connection between the paYookassaPaymentMode type and the Taxonomy type */
export type PaYookassaPaymentModeToTaxonomyConnectionEdge = {
  __typename?: 'PaYookassaPaymentModeToTaxonomyConnectionEdge';
  /** The node of the connection, without the edges */
  node?: Maybe<Taxonomy>;
};

/** The paYookassaPaymentSubject type */
export type PaYookassaPaymentSubject = DatabaseIdentifier & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'PaYookassaPaymentSubject';
  /** Connection between the paYookassaPaymentSubject type and the ContentNode type */
  contentNodes?: Maybe<PaYookassaPaymentSubjectToContentNodeConnection>;
  /** The number of objects connected to the object */
  count?: Maybe<Scalars['Int']>;
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int'];
   ...
   * @deprecated Deprecated in favor of databaseId
   */
  paYookassaPaymentSubjectId?: Maybe<Scalars['Int']>;
  /** Connection between the PaYookassaPaymentSubject type and the Product type */
  products?: Maybe<PaYookassaPaymentSubjectToProductConnection>;
  /** An alphanumeric identifier for the object unique to its type. */
  slug?: Maybe<Scalars['String']>;
  /** Connection between the paYookassaPaymentSubject type and the Taxonomy type */
  taxonomy?: Maybe<PaYookassaPaymentSubjectToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  taxonomyName?: Maybe<Scalars['String']>;
  /** The ID of the term group that this term object belongs to */
  termGroupId?: Maybe<Scalars['Int']>;
  ...
  /** The unique resource identifier path */
  uri?: Maybe<Scalars['String']>;
  /** Connection between the PaYookassaPaymentSubject type and the ProductVariation type */
  variations?: Maybe<PaYookassaPaymentSubjectToProductVariationConnection>;
};


/** The paYookassaPaymentSubject type */
export type PaYookassaPaymentSubjectContentNodesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<PaYookassaPaymentSubjectToContentNodeConnectionWhereArgs>;
};


/** The paYookassaPaymentSubject type */
export type PaYookassaPaymentSubjectEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The paYookassaPaymentSubject type */
export type PaYookassaPaymentSubjectEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The paYookassaPaymentSubject type */
export type PaYookassaPaymentSubjectProductsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<PaYookassaPaymentSubjectToProductConnectionWhereArgs>;
};


/** The paYookassaPaymentSubject type */
export type PaYookassaPaymentSubjectVariationsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<PaYookassaPaymentSubjectToProductVariationConnectionWhereArgs>;
};

/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum PaYookassaPaymentSubjectIdType {
  /** The Database ID for the node */
  DatabaseId = 'DATABASE_ID',
  /** The hashed Global ID */
  Id = 'ID',
...
/** Connection between the paYookassaPaymentSubject type and the ContentNode type */
export type PaYookassaPaymentSubjectToContentNodeConnection = {
  __typename?: 'PaYookassaPaymentSubjectToContentNodeConnection';
  /** Edges for the PaYookassaPaymentSubjectToContentNodeConnection connection */
  edges?: Maybe<Array<Maybe<PaYookassaPaymentSubjectToContentNodeConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<ContentNode>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type PaYookassaPaymentSubjectToContentNodeConnectionEdge = {
  __typename?: 'PaYookassaPaymentSubjectToContentNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<ContentNode>;
...
/** Arguments for filtering the PaYookassaPaymentSubjectToContentNodeConnection connection */
export type PaYookassaPaymentSubjectToContentNodeConnectionWhereArgs = {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<Array<InputMaybe<ContentTypesOfPaYookassaPaymentSubjectEnum>>>;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']>;
...
/** Connection between the PaYookassaPaymentSubject type and the Product type */
export type PaYookassaPaymentSubjectToProductConnection = {
  __typename?: 'PaYookassaPaymentSubjectToProductConnection';
  /** Edges for the PaYookassaPaymentSubjectToProductConnection connection */
  edges?: Maybe<Array<Maybe<PaYookassaPaymentSubjectToProductConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Product>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type PaYookassaPaymentSubjectToProductConnectionEdge = {
  __typename?: 'PaYookassaPaymentSubjectToProductConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Product>;
...
/** Arguments for filtering the PaYookassaPaymentSubjectToProductConnection connection */
export type PaYookassaPaymentSubjectToProductConnectionWhereArgs = {
  /** Limit result set to products with a specific attribute. Use the taxonomy name/attribute slug. */
  attribute?: InputMaybe<Scalars['String']>;
  /** Limit result set to products with a specific attribute term ID (required an assigned attribute). */
  attributeTerm?: InputMaybe<Scalars['String']>;
...
/** Connection between the PaYookassaPaymentSubject type and the ProductVariation type */
export type PaYookassaPaymentSubjectToProductVariationConnection = {
  __typename?: 'PaYookassaPaymentSubjectToProductVariationConnection';
  /** Edges for the PaYookassaPaymentSubjectToProductVariationConnection connection */
  edges?: Maybe<Array<Maybe<PaYookassaPaymentSubjectToProductVariationConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<ProductVariation>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type PaYookassaPaymentSubjectToProductVariationConnectionEdge = {
  __typename?: 'PaYookassaPaymentSubjectToProductVariationConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<ProductVariation>;
...
/** Arguments for filtering the PaYookassaPaymentSubjectToProductVariationConnection connection */
export type PaYookassaPaymentSubjectToProductVariationConnectionWhereArgs = {
  /** Limit result set to products with a specific attribute. Use the taxonomy name/attribute slug. */
  attribute?: InputMaybe<Scalars['String']>;
  /** Limit result set to products with a specific attribute term ID (required an assigned attribute). */
  attributeTerm?: InputMaybe<Scalars['String']>;
...
/** Connection between the paYookassaPaymentSubject type and the Taxonomy type */
export type PaYookassaPaymentSubjectToTaxonomyConnectionEdge = {
  __typename?: 'PaYookassaPaymentSubjectToTaxonomyConnectionEdge';
  /** The node of the connection, without the edges */
  node?: Maybe<Taxonomy>;
};
...
export type Page = ContentNode & DatabaseIdentifier & HierarchicalContentNode & MenuItemLinkable & Node & NodeWithAuthor & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
  ...
  /** The unique resource identifier path */
  uri?: Maybe<Scalars['String']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Вебинар — Основное&quot; was set to Show in GraphQL. */
  webinarMain?: Maybe<Page_Webinarmain>;
};
...
/** Field Group */
export type Page_Webinarmain = AcfFieldGroup & {
  __typename?: 'Page_Webinarmain';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  preview?: Maybe<MediaItem>;
  time?: Maybe<Scalars['String']>;
  webinar?: Maybe<Page_Webinarmain_Webinar>;
};

export type Page_Webinarmain_Webinar = ExternalProduct | GroupProduct | SimpleProduct | VariableProduct;

/** The Partner type */
export type Partner = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
  __typename?: 'Partner';
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  /** The name of the Content Type the node belongs to */
  ...
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Партнеры – Основное&quot; was set to Show in GraphQL. */
  partnerMain?: Maybe<Partner_Partnermain>;
...
/** Connection between the Partner type and the Partner type */
export type PartnerToPreviewConnectionEdge = {
...
/** Field Group */
export type Partner_Partnermain = AcfFieldGroup & {
  __typename?: 'Partner_Partnermain';
  city?: Maybe<Scalars['String']>;
  description?: Maybe<Scalars['String']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
...
/** The post type */
export type Post = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
  __typename?: 'Post';
  /** Connection between the NodeWithAuthor type and the User type */
  author?: Maybe<NodeWithAuthorToUserConnectionEdge>;
  /** The database identifier of the author of the node */
   ...
   */
  postId: Scalars['Int'];
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Статьи – Основное&quot; was set to Show in GraphQL. */
  postMain?: Maybe<Post_Postmain>;
...
/** Field Group */
export type Post_Postmain = AcfFieldGroup & {
  __typename?: 'Post_Postmain';
  content?: Maybe<Array<Maybe<Post_Postmain_Content>>>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  files?: Maybe<Array<Maybe<Post_Postmain_Files>>>;
};

export type Post_Postmain_Content = Post_Postmain_Content_SectionLink | Post_Postmain_Content_SectionProduct | Post_Postmain_Content_SectionSlider | Post_Postmain_Content_SectionText;

/** Group within the flex field */
export type Post_Postmain_Content_SectionLink = AcfFieldGroup & {
  __typename?: 'Post_Postmain_Content_SectionLink';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  post?: Maybe<Post_Postmain_Content_SectionLink_Post>;
};

export type Post_Postmain_Content_SectionLink_Post = Post;

/** Group within the flex field */
export type Post_Postmain_Content_SectionProduct = AcfFieldGroup & {
  __typename?: 'Post_Postmain_Content_SectionProduct';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  product?: Maybe<Post_Postmain_Content_SectionProduct_Product>;
};

export type Post_Postmain_Content_SectionProduct_Product = ExternalProduct | GroupProduct | SimpleProduct | VariableProduct;

/** Group within the flex field */
export type Post_Postmain_Content_SectionSlider = AcfFieldGroup & {
  __typename?: 'Post_Postmain_Content_SectionSlider';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
...
/** Group within the flex field */
export type Post_Postmain_Content_SectionText = AcfFieldGroup & {
  __typename?: 'Post_Postmain_Content_SectionText';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
...
/** Field Group */
export type Post_Postmain_Files = AcfFieldGroup & {
  __typename?: 'Post_Postmain_files';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  file?: Maybe<MediaItem>;
};
...
/** Product object */
export type ProductPaYookassaPaymentModesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** Product object */
export type ProductPaYookassaPaymentSubjectsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export enum ProductTaxonomyEnum {
  Payookassapaymentmode = 'PAYOOKASSAPAYMENTMODE',
  Payookassapaymentsubject = 'PAYOOKASSAPAYMENTSUBJECT',
...
/** Connection between the Product type and the paYookassaPaymentMode type */
export type ProductToPaYookassaPaymentModeConnection = {
  __typename?: 'ProductToPaYookassaPaymentModeConnection';
  /** Edges for the ProductToPaYookassaPaymentModeConnection connection */
  edges?: Maybe<Array<Maybe<ProductToPaYookassaPaymentModeConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<PaYookassaPaymentMode>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
};

/** An edge in a connection */
export type ProductToPaYookassaPaymentModeConnectionEdge = {
  __typename?: 'ProductToPaYookassaPaymentModeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<PaYookassaPaymentMode>;
};

/** Arguments for filtering the ProductToPaYookassaPaymentModeConnection connection */
export type ProductToPaYookassaPaymentModeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
/** Connection between the Product type and the paYookassaPaymentSubject type */
export type ProductToPaYookassaPaymentSubjectConnection = {
  __typename?: 'ProductToPaYookassaPaymentSubjectConnection';
  /** Edges for the ProductToPaYookassaPaymentSubjectConnection connection */
  edges?: Maybe<Array<Maybe<ProductToPaYookassaPaymentSubjectConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<PaYookassaPaymentSubject>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
};

/** An edge in a connection */
export type ProductToPaYookassaPaymentSubjectConnectionEdge = {
  __typename?: 'ProductToPaYookassaPaymentSubjectConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<PaYookassaPaymentSubject>;
};

/** Arguments for filtering the ProductToPaYookassaPaymentSubjectConnection connection */
export type ProductToPaYookassaPaymentSubjectConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
/** Field Group */
export type Product_Productadditional = AcfFieldGroup & {
  __typename?: 'Product_Productadditional';
  broadcastDate?: Maybe<Scalars['String']>;
  content?: Maybe<Array<Maybe<Product_Productadditional_Content>>>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  /** Укажите почту на которую будут приходить оповещения о заказе */
  mail?: Maybe<Scalars['String']>;
  programm?: Maybe<MediaItem>;
};

export type Product_Productadditional_Content = Product_Productadditional_Content_SectionText;

/** Group within the flex field */
export type Product_Productadditional_Content_SectionText = AcfFieldGroup & {
  __typename?: 'Product_Productadditional_Content_SectionText';
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  text?: Maybe<Scalars['String']>;
  title?: Maybe<Scalars['String']>;
...
export type RootMutation = {
  ...
  /** The payload for the createPaYookassaPaymentMode mutation */
  createPaYookassaPaymentMode?: Maybe<CreatePaYookassaPaymentModePayload>;
  /** The payload for the createPaYookassaPaymentSubject mutation */
  createPaYookassaPaymentSubject?: Maybe<CreatePaYookassaPaymentSubjectPayload>;
  /** The payload for the createPage mutation */
  ...
  /** The payload for the deletePaYookassaPaymentMode mutation */
  deletePaYookassaPaymentMode?: Maybe<DeletePaYookassaPaymentModePayload>;
  /** The payload for the deletePaYookassaPaymentSubject mutation */
  deletePaYookassaPaymentSubject?: Maybe<DeletePaYookassaPaymentSubjectPayload>;
  /** The payload for the deletePage mutation */
  ...
  /** The payload for the UpdatePaYookassaPaymentMode mutation */
  updatePaYookassaPaymentMode?: Maybe<UpdatePaYookassaPaymentModePayload>;
  /** The payload for the UpdatePaYookassaPaymentSubject mutation */
  updatePaYookassaPaymentSubject?: Maybe<UpdatePaYookassaPaymentSubjectPayload>;
...
/** The root mutation */
export type RootMutationCreatePaYookassaPaymentModeArgs = {
  input: CreatePaYookassaPaymentModeInput;
};


/** The root mutation */
export type RootMutationCreatePaYookassaPaymentSubjectArgs = {
  input: CreatePaYookassaPaymentSubjectInput;
};
...
/** The root mutation */
export type RootMutationDeletePaYookassaPaymentModeArgs = {
  input: DeletePaYookassaPaymentModeInput;
};


/** The root mutation */
export type RootMutationDeletePaYookassaPaymentSubjectArgs = {
  input: DeletePaYookassaPaymentSubjectInput;
};
...
/** The root mutation */
export type RootMutationUpdatePaYookassaPaymentModeArgs = {
  input: UpdatePaYookassaPaymentModeInput;
};


/** The root mutation */
export type RootMutationUpdatePaYookassaPaymentSubjectArgs = {
  input: UpdatePaYookassaPaymentSubjectInput;
};
...
export type RootQuery = {
  ...
  /** A 0bject */
  paYookassaPaymentMode?: Maybe<PaYookassaPaymentMode>;
  /** Connection between the RootQuery type and the paYookassaPaymentMode type */
  paYookassaPaymentModes?: Maybe<RootQueryToPaYookassaPaymentModeConnection>;
  /** A 0bject */
  paYookassaPaymentSubject?: Maybe<PaYookassaPaymentSubject>;
  /** Connection between the RootQuery type and the paYookassaPaymentSubject type */
  paYookassaPaymentSubjects?: Maybe<RootQueryToPaYookassaPaymentSubjectConnection>;
...
/** The root entry point into the Graph */
export type RootQueryPaYookassaPaymentModeArgs = {
  id: Scalars['ID'];
  idType?: InputMaybe<PaYookassaPaymentModeIdType>;
};


/** The root entry point into the Graph */
export type RootQueryPaYookassaPaymentModesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToPaYookassaPaymentModeConnectionWhereArgs>;
};


/** The root entry point into the Graph */
export type RootQueryPaYookassaPaymentSubjectArgs = {
  id: Scalars['ID'];
  idType?: InputMaybe<PaYookassaPaymentSubjectIdType>;
};


/** The root entry point into the Graph */
export type RootQueryPaYookassaPaymentSubjectsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToPaYookassaPaymentSubjectConnectionWhereArgs>;
};
...
export type RootQueryPeopleReviewArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']>;
  id: Scalars['ID'];
  idType?: InputMaybe<PeopleReviewIdType>;
};
...
export type RootQueryPeopleReviewByArgs = {
  id?: InputMaybe<Scalars['ID']>;
  peopleReviewId?: InputMaybe<Scalars['Int']>;
  slug?: InputMaybe<Scalars['String']>;
  uri?: InputMaybe<Scalars['String']>;
};
...
export type RootQueryPeopleReviewsArgs = {
  ...
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToPeopleReviewConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the paYookassaPaymentMode type */
export type RootQueryToPaYookassaPaymentModeConnection = {
  __typename?: 'RootQueryToPaYookassaPaymentModeConnection';
  /** Edges for the RootQueryToPaYookassaPaymentModeConnection connection */
  edges?: Maybe<Array<Maybe<RootQueryToPaYookassaPaymentModeConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<PaYookassaPaymentMode>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type RootQueryToPaYookassaPaymentModeConnectionEdge = {
  __typename?: 'RootQueryToPaYookassaPaymentModeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<PaYookassaPaymentMode>;
...
/** Arguments for filtering the RootQueryToPaYookassaPaymentModeConnection connection */
export type RootQueryToPaYookassaPaymentModeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
/** Connection between the RootQuery type and the paYookassaPaymentSubject type */
export type RootQueryToPaYookassaPaymentSubjectConnection = {
  __typename?: 'RootQueryToPaYookassaPaymentSubjectConnection';
  /** Edges for the RootQueryToPaYookassaPaymentSubjectConnection connection */
  edges?: Maybe<Array<Maybe<RootQueryToPaYookassaPaymentSubjectConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<PaYookassaPaymentSubject>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type RootQueryToPaYookassaPaymentSubjectConnectionEdge = {
  __typename?: 'RootQueryToPaYookassaPaymentSubjectConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<PaYookassaPaymentSubject>;
...
/** Arguments for filtering the RootQueryToPaYookassaPaymentSubjectConnection connection */
export type RootQueryToPaYookassaPaymentSubjectConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
/** Connection between the RootQuery type and the Partner type */
export type RootQueryToPartnerConnection = {
...
/** An edge in a connection */
export type RootQueryToPartnerConnectionEdge = {
...
/** A product object */
export type SimpleProductPaYookassaPaymentModesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** A product object */
export type SimpleProductPaYookassaPaymentSubjectsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export enum TaxonomyEnum {
  ...
  Category = 'CATEGORY',
  /** Taxonomy enum pa_yookassa_payment_mode */
  Payookassapaymentmode = 'PAYOOKASSAPAYMENTMODE',
  /** Taxonomy enum pa_yookassa_payment_subject */
  Payookassapaymentsubject = 'PAYOOKASSAPAYMENTSUBJECT',
...
/** Input for the UpdatePaYookassaPaymentMode mutation */
export type UpdatePaYookassaPaymentModeInput = {
  /** The slug that the pa_yookassa_payment_mode will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The description of the pa_yookassa_payment_mode object */
  description?: InputMaybe<Scalars['String']>;
  /** The ID of the paYookassaPaymentMode object to update */
  id: Scalars['ID'];
  /** The name of the pa_yookassa_payment_mode object to mutate */
  name?: InputMaybe<Scalars['String']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
...
/** The payload for the UpdatePaYookassaPaymentMode mutation */
export type UpdatePaYookassaPaymentModePayload = {
  __typename?: 'UpdatePaYookassaPaymentModePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The created pa_yookassa_payment_mode */
  paYookassaPaymentMode?: Maybe<PaYookassaPaymentMode>;
...
/** Input for the UpdatePaYookassaPaymentSubject mutation */
export type UpdatePaYookassaPaymentSubjectInput = {
  /** The slug that the pa_yookassa_payment_subject will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The description of the pa_yookassa_payment_subject object */
  description?: InputMaybe<Scalars['String']>;
  /** The ID of the paYookassaPaymentSubject object to update */
  id: Scalars['ID'];
  /** The name of the pa_yookassa_payment_subject object to mutate */
  name?: InputMaybe<Scalars['String']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
...
/** The payload for the UpdatePaYookassaPaymentSubject mutation */
export type UpdatePaYookassaPaymentSubjectPayload = {
  __typename?: 'UpdatePaYookassaPaymentSubjectPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The created pa_yookassa_payment_subject */
  paYookassaPaymentSubject?: Maybe<PaYookassaPaymentSubject>;
...
/** A variable product object */
export type VariableProductPaYookassaPaymentModesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** A variable product object */
export type VariableProductPaYookassaPaymentSubjectsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type MediaItemFragment = { __typename?: 'MediaItem', title?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined };

export type OrderFragment = { __typename?: 'Order', id: string, databaseId?: number | null | undefined, status?: OrderStatusEnum | null | undefined, total?: string | null | undefined, discountTotal?: string | null | undefined, hasBillingAddress?: boolean | null | undefined, needsPayment?: boolean | null | undefined, needsProcessing?: boolean | null | undefined, paymentMethod?: string | null | undefined, paymentMethodTitle?: string | null | undefined, date?: string | null | undefined, dateCompleted?: string | null | undefined, datePaid?: string | null | undefined, isDownloadPermitted?: boolean | null | undefined, hasDownloadableItem?: boolean | null | undefined, downloadableItems?: { __typename?: 'OrderToDownloadableItemConnection', nodes?: Array<{ __typename?: 'DownloadableItem', name?: string | null | undefined, accessExpires?: string | null | undefined, url?: string | null | undefined, download?: { __typename?: 'ProductDownload', fileExt?: string | null | undefined, fileExists?: boolean | null | undefined, fileType?: string | null | undefined, downloadId: string } | null | undefined } | null | undefined> | null | undefined } | null | undefined, lineItems?: { __typename?: 'OrderToLineItemConnection', nodes?: Array<{ __typename?: 'LineItem', orderId?: number | null | undefined, databaseId?: number | null | undefined, productId?: number | null | undefined, quantity?: number | null | undefined, product?: { __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined } | null | undefined> | null | undefined } | null | undefined, billing?: { __typename?: 'CustomerAddress', firstName?: string | null | undefined, lastName?: string | null | undefined, company?: string | null | undefined, city?: string | null | undefined, email?: string | null | undefined, phone?: string | null | undefined } | null | undefined };

export type PictureFragment = { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined };

export type PostFragment = { __typename?: 'Post', id: string, slug?: string | null | undefined, title?: string | null | undefined, excerpt?: string | null | undefined, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined } | null | undefined } | null | undefined, postMain?: { __typename?: 'Post_Postmain', files?: Array<{ __typename?: 'Post_Postmain_files', file?: { __typename?: 'MediaItem', title?: string | null | undefined, mediaItemUrl?: string | null | undefined, mimeType?: string | null | undefined, fileSize?: number | null | undefined } | null | undefined } | null | undefined> | null | undefined, content?: Array<{ __typename?: 'Post_Postmain_Content_SectionLink', fieldGroupName?: string | null | undefined, post?: { __typename?: 'Post', id: string, slug?: string | null | undefined, title?: string | null | undefined, excerpt?: string | null | undefined, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined } | null | undefined } | null | undefined } | null | undefined } | { __typename?: 'Post_Postmain_Content_SectionProduct', fieldGroupName?: string | null | undefined, product?: { __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined } | { __typename?: 'Post_Postmain_Content_SectionSlider', fieldGroupName?: string | null | undefined, gallery?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined } | null | undefined> | null | undefined } | { __typename?: 'Post_Postmain_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined };

export type ProductDownloadFragment = { __typename?: 'ProductDownload', fileExt?: string | null | undefined, fileExists?: boolean | null | undefined, fileType?: string | null | undefined, downloadId: string };
...
export type AddToCartMutation = { __typename?: 'RootMutation', addToCart?: { __typename?: 'AddToCartPayload', cart?: { __typename?: 'Cart', isEmpty?: boolean | null | undefined, total?: string | null | undefined, shippingTotal?: string | null | undefined, contentsTotal?: string | null | undefined, discountTotal?: string | null | undefined, appliedCoupons?: Array<{ __typename?: 'AppliedCoupon', code: string, discountAmount: string, discountTax: string } | null | undefined> | null | undefined, contents?: { __typename?: 'CartToCartItemConnection', itemCount?: number | null | undefined, productCount?: number | null | undefined, nodes?: Array<{ __typename?: 'CartItem', key: string, total?: string | null | undefined, quantity?: number | null | undefined, product?: { __typename?: 'CartItemToProductConnectionEdge', node?: { __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined } | null | undefined } | null | undefined> | null | undefined } | null | undefined } | null | undefined } | null | undefined };
...
export type ApplyCouponMutation = { __typename?: 'RootMutation', applyCoupon?: { __typename?: 'ApplyCouponPayload', cart?: { __typename?: 'Cart', isEmpty?: boolean | null | undefined, total?: string | null | undefined, shippingTotal?: string | null | undefined, contentsTotal?: string | null | undefined, discountTotal?: string | null | undefined, appliedCoupons?: Array<{ __typename?: 'AppliedCoupon', code: string, discountAmount: string, discountTax: string } | null | undefined> | null | undefined, contents?: { __typename?: 'CartToCartItemConnection', itemCount?: number | null | undefined, productCount?: number | null | undefined, nodes?: Array<{ __typename?: 'CartItem', key: string, total?: string | null | undefined, quantity?: number | null | undefined, product?: { __typename?: 'CartItemToProductConnectionEdge', node?: { __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined } | null | undefined } | null | undefined> | null | undefined } | null | undefined } | null | undefined } | null | undefined };
...
export type CheckoutMutation = { __typename?: 'RootMutation', checkout?: { __typename?: 'CheckoutPayload', result?: string | null | undefined, order?: { __typename?: 'Order', id: string, databaseId?: number | null | undefined, status?: OrderStatusEnum | null | undefined, total?: string | null | undefined, discountTotal?: string | null | undefined, hasBillingAddress?: boolean | null | undefined, needsPayment?: boolean | null | undefined, needsProcessing?: boolean | null | undefined, paymentMethod?: string | null | undefined, paymentMethodTitle?: string | null | undefined, date?: string | null | undefined, dateCompleted?: string | null | undefined, datePaid?: string | null | undefined, isDownloadPermitted?: boolean | null | undefined, hasDownloadableItem?: boolean | null | undefined, downloadableItems?: { __typename?: 'OrderToDownloadableItemConnection', nodes?: Array<{ __typename?: 'DownloadableItem', name?: string | null | undefined, accessExpires?: string | null | undefined, url?: string | null | undefined, download?: { __typename?: 'ProductDownload', fileExt?: string | null | undefined, fileExists?: boolean | null | undefined, fileType?: string | null | undefined, downloadId: string } | null | undefined } | null | undefined> | null | undefined } | null | undefined, lineItems?: { __typename?: 'OrderToLineItemConnection', nodes?: Array<{ __typename?: 'LineItem', orderId?: number | null | undefined, databaseId?: number | null | undefined, productId?: number | null | undefined, quantity?: number | null | undefined, product?: { __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined } | null | undefined> | null | undefined } | null | undefined, billing?: { __typename?: 'CustomerAddress', firstName?: string | null | undefined, lastName?: string | null | undefined, company?: string | null | undefined, city?: string | null | undefined, email?: string | null | undefined, phone?: string | null | undefined } | null | undefined } | null | undefined } | null | undefined };
...
export type CreateOrderMutation = { __typename?: 'RootMutation', createOrder?: { __typename?: 'CreateOrderPayload', order?: { __typename?: 'Order', id: string, databaseId?: number | null | undefined, status?: OrderStatusEnum | null | undefined, total?: string | null | undefined, discountTotal?: string | null | undefined, hasBillingAddress?: boolean | null | undefined, needsPayment?: boolean | null | undefined, needsProcessing?: boolean | null | undefined, paymentMethod?: string | null | undefined, paymentMethodTitle?: string | null | undefined, date?: string | null | undefined, dateCompleted?: string | null | undefined, datePaid?: string | null | undefined, isDownloadPermitted?: boolean | null | undefined, hasDownloadableItem?: boolean | null | undefined, downloadableItems?: { __typename?: 'OrderToDownloadableItemConnection', nodes?: Array<{ __typename?: 'DownloadableItem', name?: string | null | undefined, accessExpires?: string | null | undefined, url?: string | null | undefined, download?: { __typename?: 'ProductDownload', fileExt?: string | null | undefined, fileExists?: boolean | null | undefined, fileType?: string | null | undefined, downloadId: string } | null | undefined } | null | undefined> | null | undefined } | null | undefined, lineItems?: { __typename?: 'OrderToLineItemConnection', nodes?: Array<{ __typename?: 'LineItem', orderId?: number | null | undefined, databaseId?: number | null | undefined, productId?: number | null | undefined, quantity?: number | null | undefined, product?: { __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined } | null | undefined> | null | undefined } | null | undefined, billing?: { __typename?: 'CustomerAddress', firstName?: string | null | undefined, lastName?: string | null | undefined, company?: string | null | undefined, city?: string | null | undefined, email?: string | null | undefined, phone?: string | null | undefined } | null | undefined } | null | undefined } | null | undefined };
...
export type RemoveItemsFromCartMutation = { __typename?: 'RootMutation', removeItemsFromCart?: { __typename?: 'RemoveItemsFromCartPayload', cart?: { __typename?: 'Cart', isEmpty?: boolean | null | undefined, total?: string | null | undefined, shippingTotal?: string | null | undefined, contentsTotal?: string | null | undefined, discountTotal?: string | null | undefined, appliedCoupons?: Array<{ __typename?: 'AppliedCoupon', code: string, discountAmount: string, discountTax: string } | null | undefined> | null | undefined, contents?: { __typename?: 'CartToCartItemConnection', itemCount?: number | null | undefined, productCount?: number | null | undefined, nodes?: Array<{ __typename?: 'CartItem', key: string, total?: string | null | undefined, quantity?: number | null | undefined, product?: { __typename?: 'CartItemToProductConnectionEdge', node?: { __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined } | null | undefined } | null | undefined> | null | undefined } | null | undefined } | null | undefined } | null | undefined };
...
export type ResetUserPasswordMutation = { __typename?: 'RootMutation', resetUserPassword?: { __typename?: 'ResetUserPasswordPayload', user?: { __typename?: 'User', jwtAuthToken?: string | null | undefined } | null | undefined } | null | undefined };
...
export type SendPasswordResetEmailMutation = { __typename?: 'RootMutation', sendPasswordResetEmail?: { __typename?: 'SendPasswordResetEmailPayload', user?: { __typename?: 'User', email?: string | null | undefined } | null | undefined } | null | undefined };
...
export type GetDocumentQuery = { __typename?: 'RootQuery', document?: { __typename?: 'Document', slug?: string | null | undefined, title?: string | null | undefined, excerpt?: string | null | undefined, documentMain?: { __typename?: 'Document_Documentmain', file?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined, title?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined } | null | undefined } | null | undefined } | null | undefined };
...
export type GetDocumentsQuery = { __typename?: 'RootQuery', documents?: { __typename?: 'RootQueryToDocumentConnection', nodes?: Array<{ __typename?: 'Document', slug?: string | null | undefined, title?: string | null | undefined, excerpt?: string | null | undefined, documentMain?: { __typename?: 'Document_Documentmain', file?: { __typename?: 'MediaItem', title?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined } | null | undefined } | null | undefined } | null | undefined> | null | undefined } | null | undefined };
...
export type GetOrderQuery = { __typename?: 'RootQuery', order?: { __typename?: 'Order', id: string, databaseId?: number | null | undefined, status?: OrderStatusEnum | null | undefined, total?: string | null | undefined, discountTotal?: string | null | undefined, hasBillingAddress?: boolean | null | undefined, needsPayment?: boolean | null | undefined, needsProcessing?: boolean | null | undefined, paymentMethod?: string | null | undefined, paymentMethodTitle?: string | null | undefined, date?: string | null | undefined, dateCompleted?: string | null | undefined, datePaid?: string | null | undefined, isDownloadPermitted?: boolean | null | undefined, hasDownloadableItem?: boolean | null | undefined, downloadableItems?: { __typename?: 'OrderToDownloadableItemConnection', nodes?: Array<{ __typename?: 'DownloadableItem', name?: string | null | undefined, accessExpires?: string | null | undefined, url?: string | null | undefined, download?: { __typename?: 'ProductDownload', fileExt?: string | null | undefined, fileExists?: boolean | null | undefined, fileType?: string | null | undefined, downloadId: string } | null | undefined } | null | undefined> | null | undefined } | null | undefined, lineItems?: { __typename?: 'OrderToLineItemConnection', nodes?: Array<{ __typename?: 'LineItem', orderId?: number | null | undefined, databaseId?: number | null | undefined, productId?: number | null | undefined, quantity?: number | null | undefined, product?: { __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined } | null | undefined> | null | undefined } | null | undefined, billing?: { __typename?: 'CustomerAddress', firstName?: string | null | undefined, lastName?: string | null | undefined, company?: string | null | undefined, city?: string | null | undefined, email?: string | null | undefined, phone?: string | null | undefined } | null | undefined } | null | undefined };

export type GetOrdersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetOrdersQuery = { __typename?: 'RootQuery', orders?: { __typename?: 'RootQueryToOrderConnection', nodes?: Array<{ __typename?: 'Order', id: string, databaseId?: number | null | undefined, status?: OrderStatusEnum | null | undefined, total?: string | null | undefined, discountTotal?: string | null | undefined, hasBillingAddress?: boolean | null | undefined, needsPayment?: boolean | null | undefined, needsProcessing?: boolean | null | undefined, paymentMethod?: string | null | undefined, paymentMethodTitle?: string | null | undefined, date?: string | null | undefined, dateCompleted?: string | null | undefined, datePaid?: string | null | undefined, isDownloadPermitted?: boolean | null | undefined, hasDownloadableItem?: boolean | null | undefined, downloadableItems?: { __typename?: 'OrderToDownloadableItemConnection', nodes?: Array<{ __typename?: 'DownloadableItem', name?: string | null | undefined, accessExpires?: string | null | undefined, url?: string | null | undefined, download?: { __typename?: 'ProductDownload', fileExt?: string | null | undefined, fileExists?: boolean | null | undefined, fileType?: string | null | undefined, downloadId: string } | null | undefined } | null | undefined> | null | undefined } | null | undefined, lineItems?: { __typename?: 'OrderToLineItemConnection', nodes?: Array<{ __typename?: 'LineItem', orderId?: number | null | undefined, databaseId?: number | null | undefined, productId?: number | null | undefined, quantity?: number | null | undefined, product?: { __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined } | null | undefined> | null | undefined } | null | undefined, billing?: { __typename?: 'CustomerAddress', firstName?: string | null | undefined, lastName?: string | null | undefined, company?: string | null | undefined, city?: string | null | undefined, email?: string | null | undefined, phone?: string | null | undefined } | null | undefined } | null | undefined> | null | undefined } | null | undefined };
...
export type GetPageQuery = { __typename?: 'RootQuery', page?: { __typename?: 'Page', title?: string | null | undefined, content?: string | null | undefined } | null | undefined };

export type GetPartnersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPartnersQuery = { __typename?: 'RootQuery', partners?: { __typename?: 'RootQueryToPartnerConnection', nodes?: Array<{ __typename?: 'Partner', slug?: string | null | undefined, title?: string | null | undefined, partnerMain?: { __typename?: 'Partner_Partnermain', description?: string | null | undefined, city?: string | null | undefined, link?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined } | null | undefined } | null | undefined } | null | undefined> | null | undefined } | null | undefined };
...
export type GetPostQuery = { __typename?: 'RootQuery', post?: { __typename?: 'Post', id: string, slug?: string | null | undefined, title?: string | null | undefined, excerpt?: string | null | undefined, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined } | null | undefined } | null | undefined, postMain?: { __typename?: 'Post_Postmain', files?: Array<{ __typename?: 'Post_Postmain_files', file?: { __typename?: 'MediaItem', title?: string | null | undefined, mediaItemUrl?: string | null | undefined, mimeType?: string | null | undefined, fileSize?: number | null | undefined } | null | undefined } | null | undefined> | null | undefined, content?: Array<{ __typename?: 'Post_Postmain_Content_SectionLink', fieldGroupName?: string | null | undefined, post?: { __typename?: 'Post', id: string, slug?: string | null | undefined, title?: string | null | undefined, excerpt?: string | null | undefined, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined } | null | undefined } | null | undefined } | null | undefined } | { __typename?: 'Post_Postmain_Content_SectionProduct', fieldGroupName?: string | null | undefined, product?: { __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined } | { __typename?: 'Post_Postmain_Content_SectionSlider', fieldGroupName?: string | null | undefined, gallery?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined } | null | undefined> | null | undefined } | { __typename?: 'Post_Postmain_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | null | undefined };

export type GetPostsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPostsQuery = { __typename?: 'RootQuery', posts?: { __typename?: 'RootQueryToPostConnection', nodes?: Array<{ __typename?: 'Post', id: string, slug?: string | null | undefined, title?: string | null | undefined, excerpt?: string | null | undefined, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined } | null | undefined } | null | undefined, postMain?: { __typename?: 'Post_Postmain', files?: Array<{ __typename?: 'Post_Postmain_files', file?: { __typename?: 'MediaItem', title?: string | null | undefined, mediaItemUrl?: string | null | undefined, mimeType?: string | null | undefined, fileSize?: number | null | undefined } | null | undefined } | null | undefined> | null | undefined, content?: Array<{ __typename?: 'Post_Postmain_Content_SectionLink', fieldGroupName?: string | null | undefined, post?: { __typename?: 'Post', id: string, slug?: string | null | undefined, title?: string | null | undefined, excerpt?: string | null | undefined, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined } | null | undefined } | null | undefined } | null | undefined } | { __typename?: 'Post_Postmain_Content_SectionProduct', fieldGroupName?: string | null | undefined, product?: { __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined } | { __typename?: 'Post_Postmain_Content_SectionSlider', fieldGroupName?: string | null | undefined, gallery?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined } | null | undefined> | null | undefined } | { __typename?: 'Post_Postmain_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | null | undefined> | null | undefined } | null | undefined };
...
export type GetProductsQuery = { __typename?: 'RootQuery', products?: { __typename?: 'RootQueryToProductConnection', nodes?: Array<{ __typename?: 'ExternalProduct' } | { __typename?: 'GroupProduct' } | { __typename?: 'SimpleProduct', id: string, databaseId: number, name?: string | null | undefined, slug?: string | null | undefined, price?: string | null | undefined, regularPrice?: string | null | undefined, salePrice?: string | null | undefined, shortDescription?: string | null | undefined, image?: { __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined, galleryImages?: { __typename?: 'ProductToMediaItemConnection', nodes?: Array<{ __typename?: 'MediaItem', sourceUrl?: string | null | undefined, fileSize?: number | null | undefined, mimeType?: string | null | undefined, altText?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productAdditional?: { __typename?: 'Product_Productadditional', mail?: string | null | undefined, broadcastDate?: string | null | undefined, programm?: { __typename?: 'MediaItem', mediaItemUrl?: string | null | undefined } | null | undefined, content?: Array<{ __typename?: 'Product_Productadditional_Content_SectionText', title?: string | null | undefined, text?: string | null | undefined, fieldGroupName?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined, productCategories?: { __typename?: 'ProductToProductCategoryConnection', nodes?: Array<{ __typename?: 'ProductCategory', slug?: string | null | undefined, name?: string | null | undefined } | null | undefined> | null | undefined } | null | undefined } | { __typename?: 'VariableProduct' } | null | undefined> | null | undefined } | null | undefined };
...
export const RemoveCouponsDocument = gql`
  ...
  removeCoupons(input: $input) {
    ...
    ${CartFragmentDoc}`;
export type RemoveCouponsMutationFn = Apollo.MutationFunction<RemoveCouponsMutation, RemoveCouponsMutationVariables>;
...
export function useRemoveCouponsMutation(baseOptions?: Apollo.MutationHookOptions<RemoveCouponsMutation, RemoveCouponsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RemoveCouponsMutation, RemoveCouponsMutationVariables>(RemoveCouponsDocument, options);
      }
export type RemoveCouponsMutationHookResult = ReturnType<typeof useRemoveCouponsMutation>;
export type RemoveCouponsMutationResult = Apollo.MutationResult<RemoveCouponsMutation>;
export type RemoveCouponsMutationOptions = Apollo.BaseMutationOptions<RemoveCouponsMutation, RemoveCouponsMutationVariables>;
...
export const UpdateItemQuantitiesDocument = gql`
  ...
  updateItemQuantities(input: $input) {
    ...
    ${CartFragmentDoc}`;
export type UpdateItemQuantitiesMutationFn = Apollo.MutationFunction<UpdateItemQuantitiesMutation, UpdateItemQuantitiesMutationVariables>;

/**
 * __useUpdateItemQuantitiesMutation__
 *
 * To run a mutation, you first call `useUpdateItemQuantitiesMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateItemQuantitiesMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateItemQuantitiesMutation, { data, loading, error }] = useUpdateItemQuantitiesMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateItemQuantitiesMutation(baseOptions?: Apollo.MutationHookOptions<UpdateItemQuantitiesMutation, UpdateItemQuantitiesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateItemQuantitiesMutation, UpdateItemQuantitiesMutationVariables>(UpdateItemQuantitiesDocument, options);
      }
